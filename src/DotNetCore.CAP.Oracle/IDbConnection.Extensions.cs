...
namespace DotNetCore.CAP.Oracle
{
    ...
    {
        public static int ExecuteNonQuery(this DbConnection connection, string sql, DbTransaction transaction = null,
        ...
        public static T ExecuteReader<T>(this DbConnection connection, string sql, Func<IDataReader, T> readerFunc,
            params object[] sqlParams)
        {
            if (connection.State == ConnectionState.Closed)
            {
        ...
        public static T ExecuteScalar<T>(this DbConnection connection, string sql, params object[] sqlParams)
        {
            if (connection.State == ConnectionState.Closed)
            {
                connection.Open();
